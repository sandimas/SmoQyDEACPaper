...
if __name__ == "__main__":
    ...
    Model = Maxent(filename = sys.argv[1], beta=10., kernel = "fermionic_time", numRfre = 201, wmin = -10, wmax = 10, defaultModel = "gaussian", dCenter=0, gaussianSigma=4, tol = 1e-7, std = (True, 1.0), alphamin = -2, alphamax = 1, numAlpha = 100, draw = True)
    Model.getAllSpecFs()
